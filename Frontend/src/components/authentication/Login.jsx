...
const Login = () => {
    ...
    return (
        <>
            ...
            <div className="relative flex flex-col text-gray-700 bg-white shadow-md w-96 rounded-xl bg-clip-border mt-36">
                ...
                <div className="p-6 pt-0">
                    ...
                    <p className="flex justify-center mt-6 font-sans text-sm antialiased font-light leading-normal text-inherit">
                        ...
                        <Link className="block ml-1 font-sans text-sm antialiased font-bold leading-normal text-blue-gray-900" to="/signUp">Sign Up</Link>
                    </p>
                </div>
            </div>
        </>
