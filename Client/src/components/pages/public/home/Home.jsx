...
const SocialLink = ({ href, label, icon }) => (
    <a href={href} aria-label={label} target='_blank' rel="noopener noreferrer" title={label} className="text-2xl">
        {icon}
    </a>
);
...
const Home = () => {
    return (
        <section id="home" className="h-full w-full">
            <div id="home-container" className="mx-auto flex h-full w-full items-center justify-between bg-primary p-4 lg:p-10">
                ...
                <main id='home-wrapper' className='flex flex-col items-center justify-center lg:flex-row-reverse'>
                    ...
                    <figure id='dp-container' className="relative flex w-full items-center justify-center">
                        ...
                        <img
                            id='dp-pic'
                            className='w-[50%] rounded-full object-cover shadow-lg'
                            src={homeImg}
                            alt="A photo of Samuvel A, a MERN stack web developer"
                            loading="lazy"
                        />

                        <figcaption className="hidden text-xl lg:block">
                            <div id='mern-icons-container' className="flex gap-2 text-lg">
                                M<div id='mern-icons'>
                                    <SiMongodb />
                                </div>
                                E<div id='mern-icons'>
                    ...
                    <div id='home-content' className="flex w-full flex-col justify-center gap-3 text-base">
                        ...
                        <p id='intro-para' className='text-justify text-xl leading-relaxed'>
                            I come from the picturesque coastal town of Kanyakumari, Tamil Nadu. With a deep passion for web development, I am actively seeking a Web Developer role or internship to gain hands-on experience. As a fast learner and a team player, I am confident in my ability to contribute effectively to any web development team.

                            I am eager to discuss potential opportunities. Please feel free to reach out to me anytime.
                        </p>
