...
const Signup = () => {
    ...
    return (
        <section id="signUp" className="h-[92.3vh] mx-auto flex justify-center items-center">
            <div id="signUp-container" className="container h-full w-full mx-auto flex justify-center items-center">
                ...
                <div className="relative h-full w-1/2 flex flex-col justify-center items-center text-gray-700 shadow-none rounded-xl bg-clip-border gap-3">
                    ...
                    <div className="mt-5 w-full flex justify-center">
                        <Link
                            to="/login"
                            className="text-sm font-sans font-semibold text-blue-gray-900 hover:text-blue-gray-700">
