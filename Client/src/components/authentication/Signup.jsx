...
const Signup = () => {
    ...
    return (
        <section id="signUp" className="mx-auto flex h-[92.3vh] items-center justify-center">
            <div id="signUp-container" className="container flex items-center justify-center w-full h-full mx-auto">
                ...
                <div className="relative flex flex-col items-center justify-center w-1/2 h-full gap-3 text-gray-700 shadow-none rounded-xl bg-clip-border">
                    ...
                    <div className="flex justify-center w-full mt-5">
                        <Link
                            to="/login"
                            className="font-sans text-sm font-semibold text-blue-gray-900 hover:text-blue-gray-700">
